 ...
 */
class RestaurantsAdapter(val clickListener: SearchRestaurantsFragment.OnRestaurantSelectionListener) : PagedListAdapter<Restaurant, RecyclerView.ViewHolder>(RESTAURANT_COMPARATOR) {
